...
const SingleProductpage = () => {
  ...
  const getData = () => {
    axios
      .get(`https://639b3492d5141501974eaf28.mockapi.io/nykaa?id=${id}`)
      .then((data) => {
    ...
    <Box mt={"50px"}>
      <Flex>
        ...
        <Box w={"40%"} mt={["1%", "6%"]} textAlign={"center"}>
          ...
          <Text>Rs.{singleDress.price}</Text>
          <br />
          <Text>Category - {singleDress.category}</Text>
          <br />
          ...
          <Button
            ...
            onClick={() => HandleCart(singleDress)}
          >
            Add to Cart
          </Button>
        </Box>
