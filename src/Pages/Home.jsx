...
const Home = () => {
  return (
    <Box mt={'15px'} >
      ...
      <Box width={'15%'} margin={'auto'} mt={'50px'} > <Image src={Screenshot1} /> </Box>
      <Grid width={'75%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)','repeat(4, 1fr)']} gap={6} fontSize={'17px'} textAlign={'center'} >
        <GridItem>
      ...
      <Box mt={'50px'}>
        <Heading fontSize={'34px'} textAlign='center' >our exclusive brands</Heading>
        <Grid width={'75%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)','repeat(4, 1fr)']} gap={6}>
          <GridItem>
      ...
      <Box mt={'50px'}>
      <Heading fontSize={'34px'} textAlign='center' > bestsellers <br /> going fast!</Heading>
      <Grid width={'70%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)', 'repeat(3, 1fr)','repeat(5, 1fr)']} gap={6} fontSize={'18px'} textAlign={'center'} >
        <GridItem>
      ...
      <Box width={'98%'} margin='auto' mt={'50px'}  >
        <Image width={'100%'} src='https://prod.davidsbridal.com/content/dam/aem-integration/brand/homepage/HOP_HP_Banner_Desktop_v2.jpg' />
      </Box>

      {/* beautifully designed, perfectly priced */}

      <Box mt={'50px'}>
      <Heading fontSize={'34px'} textAlign='center' >beautifully designed, <br /> perfectly priced</Heading>
      <Grid width={'70%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)','repeat(4, 1fr)']} gap={6} fontSize={'19px'} textAlign={'center'} >
        <GridItem>
      ...
      <Heading pt={'60px'} fontSize={'34px'} textAlign='center' >how we are here <br /> to serve you</Heading>
      <Grid width={'70%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)','repeat(4, 1fr)']} gap={6} pb={'60px'} fontSize={'19px'} textAlign={'center'} >
        <GridItem>
      ...
      <Box backgroundColor={'rgb(250, 244, 239)'} mt={'50px'}>
      <Heading pt={'60px'} fontSize={'34px'} textAlign='center' >more ways <br /> to save</Heading>
      <Grid width={'70%'} margin='auto' mt={'50px'} templateColumns={['repeat(1, 1fr)','repeat(3, 1fr)']} gap={6}  pb={'60px'} fontSize={'19px'} textAlign={'center'} >
        <GridItem>
      ...
      <Box width={'98%'} margin='auto' mt={'50px'}  >
        <Image width={'100%'} src='https://prod.davidsbridal.com/content/dam/aem-integration/brand/homepage/HP_Module_SBB_Desktop.jpg' />
      </Box>
